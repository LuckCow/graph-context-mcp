...
Loading is lenient by contract: any failure degrades to the provided
fresh state with a logged warning, never a crash.
"""
...
class SessionPersister:
    ...
    async def load_or_fresh(cls, store: SessionStore, fresh: SessionState) -> SessionState:
        ...
        except Exception:  # noqa: BLE001 -- lenient-load contract

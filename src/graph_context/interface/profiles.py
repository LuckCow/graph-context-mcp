...
Actions:
  ...
  list   -- every scheduled event: id, schedule and next fire, target
            chat, mode, message or prompt, status. Also shows the
            current server time -- call this when you need today's date.
...
message, Schedule prompt, Schedule mode, Schedule status, Last fired),
